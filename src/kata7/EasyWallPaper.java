...
// width of the rolls = 52 centimeterss / 100
// length of a roll = 10 meters
// buy a length that is 15% greater
// calculate the l,w,h,of rolls and return in plain english
...
//
//        FORTH: the number of rolls will be a positive or null integer (not a plain English word;
//        this number can be greater than 20)
//
...
public class EasyWallPaper {
    public static void main(String[] args) {
        ...
        System.out.println(wallpaper(0.0, 3.5, 3.0 ));

    }

    public static final double wallPaperWidth = 0.52;
    public static final double wallPaperLength = 10;
    public static final double percent = 1.15;
    ...
    public static int getRollCount(double l, double w, double h) {
        if (l == 0 || w == 0 || h == 0) {
            return 0;
        }
        return (int) ((l + w) * 2 * h * percent / (wallPaperWidth * wallPaperLength)) + 1;
    }

    public static String wallpaper(double l, double w, double h) {
        // help John!
        int rollCount = EasyWallPaper.getRollCount(l, w, h);
