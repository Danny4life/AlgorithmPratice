...
//
//        The sperm cell determines the sex of an individual in this case. I
//        f a sperm cell containing an X chromosome fertilizes an egg,
...
public class ChromosomeCheck {
    public static String chromosomeCheck(String sperm) {
        ...
        //String female = "X";
        if(sperm == "XX") {
            return "Congratulations! You are going to have a son";
        } else {
            return "Congratulations! You are going to have a daughter";
